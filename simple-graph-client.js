...
class SimpleGraphClient {
    ...
    async createEvent(meetingDetails) {

        var theStart =  moment(meetingDetails.meetingDateTime);
        var theEnd = moment(theStart).add(1,'h'); // default to 1 hour meeting - future update to add duration
         // Create the event.
        const event = {
            "subject": meetingDetails.subject,
            "start": {
                "dateTime": theStart.toJSON(),
                "timeZone": "UTC"
            },
            "end": {
                "dateTime": theEnd.toJSON(),
                "timeZone": "UTC"
            },
            "attendees":[
                {
